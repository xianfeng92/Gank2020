...
import com.xforg.g2020.base.BaseApplication;
import com.xforg.gank2020.utils.NetworkUtils;
...
public class RequestManager {
    ...
    public static void getList(Object tag, final String url, final Type type, final boolean isCache, final HttpListener listener) {
        ...
        if (!NetworkUtils.isConnectedByState(BaseApplication.getContext())) {
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        handleResponse(json, callBack, url, isCache);
                    }
                });
